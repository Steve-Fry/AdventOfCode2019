...
namespace Advent_of_Code.Day_03
{
    class Day_03
    {
        public void Run()
        {
            ...
            WireCrossingChecker crossingChecker = new WireCrossingChecker(
            ...
            Console.WriteLine($"First Crossing: {crossingChecker.GetFirstCrossing()}");
            Console.WriteLine($"=====Day 3, part 2=====");
            Console.WriteLine($"Nearest wire intersection: {crossingChecker.GetClosestIntersection()}");
            Console.WriteLine("");

            Console.WriteLine($"Day 3 completed in {stopWatch.ElapsedMilliseconds} ms");
            Console.WriteLine();
            Console.WriteLine();
